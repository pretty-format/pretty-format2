...
const prettyFormat2 = require('./');
// const ReactTestComponent = require('../build/plugins/ReactTestComponent');
const fixture = require('./fixture.geo.json');
...
function test(name, value, ignoreResult, prettyFormatOpts) {
  ...
  const formatted2 = testCase(
    'prettyFormat2()  ',
    () => prettyFormat2(value, prettyFormatOpts)
  );
  ...
  const results = [formatted, formatted2, inspected, stringified].sort((a, b) => {
